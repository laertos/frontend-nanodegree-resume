...
--------------------------------------------------------
1. Download or clone the repository into your local machine. (https://github.com/laertos/website-optimization)
2. Navigate to index.html to open the resume in a local server.
